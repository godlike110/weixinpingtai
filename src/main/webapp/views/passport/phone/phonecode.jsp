...
<!-- 新版样式导航 -->
		<jsp:include page="/views/phoneHeader.jsp">
			<jsp:param value="填写验证码" name="page_title" />
		</jsp:include>

<section class="login_module">
    <div class="login_tips_words">欢迎登录搜狐焦点</div>
    <div class="login_form">
        <div class="login_form_code"><div class="codeBox"><i class="codeIco"></i><input type="tel" placeholder="请输入验证码" maxlength="5" id="phoneCode" data-type="number"><div class="clear"></div></div><div class="getCode " id="getCode">获取验证码</div></div>
        <div class="login_form_warnTips">请输入正确验证码！</div>
        <div class="login_form_btn" id="login_form_loginBtn">登录</div>
...
<script src="http://192.168.242.44/sceapp/focus_static/wap/phone/snippets/header-new.js" type="text/javascript"></script>
...
<script src="http://192.168.242.44/sceapp/focus_static/wap/phone/snippets/wap_login_code.js" type="text/javascript"></script>
