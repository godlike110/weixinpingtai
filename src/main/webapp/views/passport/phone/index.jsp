	...
	<div class="login_container" id="login_container1">
     	...
     	<div class="login_container_nr">
			...
			<div class="login_container_yanzhengma clearfix">
				<div class="fl"><img class="login_container_yanzhengma_img" src="/user/capture/get?uuid=${uuid}&time=1396345405630" alt="验证码" style="vertical-align:middle" width="80" height="34" /></div>
