...
<!-- 保存到主屏默认的标题 -->
<title>组合贷款计算器最新2014_个人住房贷款计算器 -搜狐焦点</title>
<meta name="Keywords" content="组合贷款计算器,组合贷款计算器最新2014">
<meta name="Description"
	content="搜狐焦点网为购房者提供2014最新组合贷款计算器，根据商业贷款总额、公积金贷款总额、按揭年数、银行利率等方式计算出等额本息、等额本金贷款还款额度">
<link rel="stylesheet" type="text/css"
	href="http://192.168.242.44/sceapp/focus_static/wap/common/css/css_mobile_common_v1.1.css">
<!--<link rel="stylesheet" type="text/css" href="http://192.168.242.44/sceapp/focus_static/wap/calculator/phone/css/phone_calculator_v1.0.css">-->
<link
...
<body class="wap_home_all">
		...
		<section class="calculator_main">
			<div class="swiper-container calculator_nav_swiper">
				<ul class="swiper-wrapper">
			        ...
			        <li class="swiper-slide" data-index="2" data-selected="true"><a href="${ctx}/tools/zhdk/">组合贷款</a><em>◆</em></li>
				...
				<div class="calculator_method">
						...
						<div class="calculator_method_nr_box" style="display: block;">
							<div class="daikuan_total clearfix marginbottom20">
								...
								<div class="daikuan_total_inputbox input_skin1">
									<div class="daikuan_total_input_father its_sydk">
										<input type="tel" maxlength="5" role="text-number"
											class="daikuan_total_input" id="total_business_loan"
											placeholder="0" maxlength="9" max="10000" min="0" />
									</div>
									<span class="width120">商业贷款总额：</span>
								</div>
							...
							<div class="daikuan_total clearfix marginbottom20">
								<div class="wy fr">万元</div>
								<div class="daikuan_total_inputbox input_skin1">
									<div class="daikuan_total_input_father its_gjj">
										<input type="tel" maxlength="5" role="text-number"
											class="daikuan_total_input" id="total_fund_loan"
											placeholder="0" maxlength="9" max="10000" min="0" />
									</div>
									<span class="width135">公积金贷款总额：</span>
								</div>
							...
							<div class="daikuan_total clearfix marginbottom20">
								...
								<div
									class="daikuan_total_inputbox daikuan_total_inputbox3 input_skin1 fund_input_wrapper">
									<div class="daikuan_total_input_father">
										<input type="number" role="text-number"
											class="daikuan_total_input" id="fund_rate" placeholder="0"
											maxlength="9" max="10000" min="0" value="4.5"
											data-value="4.5" />
									</div>
									<span>公积金：</span>
								</div>
								<div class="error_msg" data-for="fund_rate">输入项不能为空</div>
							</div>
							<div class="daikuan_total clearfix marginbottom20">
								<div class="fr bank_rate">
								...
								<div
									class="daikuan_total_inputbox daikuan_total_inputbox3 input_skin1 business_input_wrapper">
									<div class="daikuan_total_input_father">
										<input type="number" role="text-number"
											class="daikuan_total_input" id="business_rate"
											placeholder="0" maxlength="9" max="10000" min="0"
											value="6.55" data-value="6.55" />
									</div>
									<span>商业：</span>
								</div>
								<div class="error_msg" data-for="business_rate">输入项不能为空</div>
							</div>
					...
					<div class="calculator_btn_container">
						<div class="calculator_btn_box">
							<span class="calculator_btn" id="calculator_btn1"
					...
					<div class="calculator_result_container"
						...
						<h2>计算结果</h2>
						<div class="calculator_result_tab_box" style="display: block;"
							data-title="等额本息—计算结果">
						...
						<div class="calculator_result_tab_box" data-title="等额本金—计算结果">
							...
							<div class="look_daikuan_detail">
								<a id="view_detail_link" role="lookDaikuanDetail_text"
									href="javascript:;" target="_blank" title="等额本金—查看还款详情"><em></em>查看还款详情</a>
							</div>
		...
		<footer class="foot_nav" style="margin-top:;">
			...
			<div class="foot_nav_box2">
				...
				<ul class="nav_box_ul1 wap_version_menu_ul1">
					...
					<li><a
						href="http://house.focus.cn/fangdaijisuanqi/zuhedaikuan/?cfrom=mobile"
						role="text" data-go="false" 
						url="http://house.focus.cn/fangdaijisuanqi/zuhedaikuan/?cfrom=mobile">电脑版</a></li>
					<%-- <li><a
						href="http://${_city.sourceDomainName}/common/modules/housemarket/housemarket3_debx.php?cfrom=mobile"
						role="text"
						url="http://${_city.sourceDomainName}/common/modules/housemarket/housemarket3_debx.php?cfrom=mobile">电脑版</a></li> --%>
				</ul>
			</div>
		</footer>
		<!-- // 底部导航 -->
	...
	<script
		src="http://192.168.242.44/sceapp/focus_static/wap/jsq/phone/snippets/phone_combination_loan_v1.0.js"></script>
	<script
