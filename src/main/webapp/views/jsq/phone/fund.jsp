...
<!-- 保存到主屏默认的标题 -->
<title>公积金贷款计算器最新2014_个人住房贷款计算器 -搜狐焦点</title>
<meta name="Keywords" content="公积金贷款计算器,住房公积金贷款计算器最新2014,个人住房公积金贷款计算器">
<meta name="Description"
	content="搜狐焦点网为购房者提供2014最新公积金贷款计算器从各个角度计算方式，根据单价、面积、住房公积金按揭年数、公积金贷款银行利率等方式计算出等额本息还款、等额本金还款等额度。">
...
<body class="wap_home_all">
		...
		<section class="calculator_main">
			<div class="swiper-container calculator_nav_swiper">
				<ul class="swiper-wrapper">
			        ...
			        <li class="swiper-slide" data-index="1" data-selected="true"><a href="${ctx}/tools/gjjdk/">公积金贷款</a><em>◆</em></li>
								...
								<div
									...
									<div class="daikuan_total_input_father">
										<input type="number" role="text-number"
											...
											maxlength="9" value="4.50" data-value="4.5" />
									</div>
									<span>银行利率：</span>
								</div>
								...
								<div
									...
									<div class="daikuan_total_input_father">
										<input type="number" role="text-number"
											...
											placeholder="0" maxlength="9" value="4.50" data-value="4.5" />
									</div>
									<span>银行利率：</span>
								</div>
					...
					<div class="calculator_result_container"
						...
						<div class="calculator_result_tab_box" data-title="等额本金—计算结果">
							...
							<div class="look_daikuan_detail">
								<a role="lookDaikuanDetail_text" id="view_detail_link"
									href="javascript:;" title="等额本金—查看还款详情"><em></em>查看还款详情</a>
							</div>
							<!-- 查看还款详情 —— 单价计算  <div class="look_daikuan_detail"><a href="/m/a.jsp?method=single&price=95000&area=130&percentage=70%&totaltime=25&rate=4.3%"></a></div> -->
						</div>
						<div class="border606060 marginbottom20"></div>
		...
		<footer class="foot_nav" style="margin-top:;">
			...
			<div class="foot_nav_box2">
				...
				<ul class="nav_box_ul1 wap_version_menu_ul1">
					...
					<%-- <li><a
						href="http://${_city.sourceDomainName}/common/modules/housemarket/housemarket3_grgjj.php?cfrom=mobile"
						role="text"
						url="http://${_city.domainName}/common/modules/housemarket/housemarket3_grgjj.php">电脑版</a></li> --%>
						<li><a href="http://house.focus.cn/fangdaijisuanqi/gongjijindaikuan/?cfrom=mobile" role="text"
						url="http://house.focus.cn/fangdaijisuanqi/gongjijindaikuan/?cfrom=mobile" data-go="false">电脑版</a></li>
	...
	<script
		src="http://192.168.242.44/sceapp/focus_static/wap/jsq/phone/snippets/phone_housingFund_loan_v1.0.js"></script>
