...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="商业贷款计算器-搜狐焦点网" />
    <meta name="keywords" content="个人住房贷款计算器,商业贷款计算器"/>
    <meta name="description" content="搜狐焦点网为购房者提供2014最新个人商业贷款计算器，按照贷款总额、按揭年数、银行利率等方式计算出等额本息、等额本金的贷款还款额度。" />
...
<body>
    ...
    <section class="container_container">
        ...
        <div class="calculator_container">
            ...
            <div class="form_item">
                ...
                <input type="number" role="touch_bg" id="rate" class="text small_text" value="6.55" data-value="6.55" data-type="number" />
                <span>%</span>
            ...
            <div class="tooltip_container" data-for="doubt_btn">
                ...
                <div class="tooltip">
                    <p>以购买的产权住房为抵押与银行进行借贷，比公积金贷款还的多。最 长贷款年限30年，且还款年限不得超过65岁。</p>
                </div>
            </div>
        </div>
        <!--计算结果-->
        <div class="result">
            ...
            <div class="detail_container display_none">
                <a href="javascript:;" id="detail_btn"><span class="icon detail_icon"></span>查看还款详情</a>
                <hr class="seperator" />
            </div>
            <div class="result_container">
    ...
    <section class="crumb">
		<div class="inner">
			<a class="inner_link" href="${ctx}/${_city.cityPinyinAbbr}/">新房</a>&gt;<a class="inner_link" href="${ctx}/tools/sydk/">商业贷款计算器</a>
		</div>
	</section>
    <footer class="clearfix">
		...
		<div class="switch_version">
			...
			<div class="version_list">
				...
				<a role="touch_bg" href="http://house.focus.cn/fangdaijisuanqi/shangyedaikuan/?cfrom=mobile" class="pc">电脑版</a>
