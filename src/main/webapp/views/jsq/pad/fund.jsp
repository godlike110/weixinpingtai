...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="公积金贷款计算器-搜狐焦点网" />
    <meta name="keywords" content="公积金贷款计算器,住房公积金贷款计算器最新2014,个人住房公积金贷款计算器"/>
    <meta name="description" content="搜狐焦点网为购房者提供2014最新公积金贷款计算器从各个角度计算方式，根据单价、面积、住房公积金按揭年数、公积金贷款银行利率等方式计算出等额本息还款、等额本金还款等额度。" />
    <title>公积金贷款计算器_个人住房公积金贷款计算器最新2014-搜狐焦点</title>
    ...
    <link href="http://192.168.242.44/sceapp/focus_static/wap/jsq/pad/css/fund_loan.css" rel="stylesheet" />
...
<body>
	...
	<jsp:include page="/views/padHeader.jsp">
		<jsp:param value="公积金贷款计算器" name="page_title" />
	</jsp:include>
    <!--左侧导航-->
    <nav class="left_navigator">
        <a href="${ctx}/tools/sydk/" class="normal_nav" id="business_nav">商业贷款</a>
        <a href="${ctx}/tools/gjjdk/" class="normal_nav selected_nav" id="fund_nav">公积金贷款</a>
    ...
    <section class="container_container">
        ...
        <div class="calculator_container">
            ...
            <div class="margin_top_15">
                <button role="touch_bg" type="button" id="total_price" data-name="compute_mode" class="radio_button left_radio_button radio_button_checked">总价计算
                    <span class="icon triangle"></span>
                </button>
                <button role="touch_bg" type="button" id="unit_price" data-name="compute_mode" class="radio_button right_radio_button">单价计算
                    <span class="icon triangle"></span>
                </button>                
            </div>
            <!--贷款总额-->
            <div class="form_item" data-type="total_price">
                <span class="text_label">贷款总额：</span>
                <input role="touch_bg" type="number" id="total_loan" class="text" data-type="number" maxlength="5" placeholder="0" />
                <span>万元</span>
                <div class="error_msg" data-for="total_loan">输入项不能为空</div>
            </div>

            <!--单价-->
            <div class="form_item display_none" data-type="unit_price">
                <span class="text_label">单价：</span>
                <input role="touch_bg" type="number" class="text two_words_text" id="house_price" data-type="number" placeholder="0" />
                <span>元/平方米</span>
                <div class="error_msg" data-for="house_price">输入项不能为空</div>
            </div>
            <!--面积-->
            <div class="form_item display_none" data-type="unit_price">
                <span class="text_label">面积：</span>
                <input type="number" role="touch_bg" class="text two_words_text" id="house_size" data-type="number" placeholder="0" />
                <span>平方米</span>
                <div class="error_msg" data-for="house_size">输入项不能为空</div>
            </div>            
            <!--按揭成数-->
            <hr class="form_seperator form_item display_none" data-type="unit_price" />
            <div class="form_item display_none" data-type="unit_price">
                <span class="text_label">按揭成数：</span>
                <select class="common_select" role="touch_bg" id="loan_percent">
            ...
            <hr class="form_seperator form_item" data-type="total_price" />
            <!--按揭年数-->
            <div class="form_item">
            ...
            <!--银行利率-->
            <div class="form_item">
                <span class="text_label">银行利率：</span>
                <input type="number" role="touch_bg" id="rate" class="text small_text" value="4.50" data-value="4.50" data-type="number" />
                <span>%</span>
            ...
            <div class="tooltip_container" data-for="doubt_btn">
                ...
                <div class="tooltip">
                    <p>个人缴存公积金一定期限以上，可申请公积金贷款。贷款上限各地不同，一般低于商业贷款。利率比商贷低，最长贷款年限30年。</p>
                </div>
            </div>
        </div>
        <!--计算结果-->
        <div class="result">
            ...
            <div class="result_container">
				<dl class="clearfix display_none" data-price="unit_price">
					<dt class="result_left_label fl">房屋总价：</dt>
					<dd class="result_right_text fr" id="house_total_price">0元</dd>
				</dl>
				<dl class="clearfix">
    ...
    <section class="crumb">
		<div class="inner">
			<a class="inner_link" href="${ctx}/${_city.cityPinyinAbbr}/">新房</a>&gt;<a class="inner_link" href="${ctx}/tools/gjjdk/">公积金贷款计算器</a>
		</div>
	</section>
    <footer class="clearfix">
		...
		<div class="switch_version">
			...
			<div class="version_list">
				...
				<a role="touch_bg" href="http://house.focus.cn/fangdaijisuanqi/gongjijindaikuan/?cfrom=mobile" class="pc">电脑版</a>
				<%-- <a role="touch_bg" href="http://${_city.sourceDomainName}/common/modules/housemarket/housemarket3_grgjj.php?cfrom=mobile" class="pc">电脑版</a> --%>
			</div>
		</div>
    ...
    <script src="http://192.168.242.44/sceapp/focus_static/wap/jsq/pad/snippets/business_loan.js"></script>
